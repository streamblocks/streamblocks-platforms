	...
	ports_out(%Out: !fifo.input_port<i32>)
{
	...
	cal.action "transmit" priority=0 {
		// Guard: Start
		cal.predicate {
			%tmp_2 = cal.get(%l_counter__10: !cal.state_ref<i32>) : i32
			// Evaluate global variable $eval5.
			%tmp_3 = arith.constant 2 : i2
			%tmp_4 = arith.extui %tmp_3 : i2 to i32
			// Evaluate global variable $eval5 done: assigned to tmp_4 above in this context.
			%tmp_5 = arith.cmpi slt, %tmp_2, %tmp_4 : i32
			cal.predicate_result %tmp_5 : i1
		}
		// Guard: End
		// Action Local Variable Decl: Start
		%tmp_6 = cal.get(%l_counter__10: !cal.state_ref<i32>) : i32
		%tmp_7 = arith.constant 100 : i7
		...
		%tmp_11 = arith.muli %tmp_10, %tmp_9 : i32
		%tmp_12 = arith.addi %tmp_6, %tmp_11 : i32
		// l_t__11_d1_0 aliased to tmp_12
		// Action Local Variable Decl: End
		// Assignment Statement: Start
		%tmp_13 = arith.constant 1 : i1
		%tmp_14 = arith.extui %tmp_13 : i1 to i32
		%tmp_15 = arith.addi %tmp_12, %tmp_14 : i32
		// l_t__11_d1_1 aliased to tmp_15
		// Assignment Statement: End
		// Call Statement: Start
		fifo.print("Tx1: %i\n\00", %tmp_15) : (i32)
		// Call Statement: End
		// Assignment Statement: Start
		%tmp_16 = cal.get(%l_counter__10: !cal.state_ref<i32>) : i32
		%tmp_17 = arith.constant 1 : i1
		%tmp_18 = arith.extui %tmp_17 : i1 to i32
		%tmp_19 = arith.addi %tmp_16, %tmp_18 : i32
		cal.set(%l_counter__10: !cal.state_ref<i32>, %tmp_19: i32)
		// Assignment Statement: End
		// Output Expression: Start
		fifo.push(%Out: !fifo.input_port<i32>, %tmp_15: i32)
		// Output Expression: End
	...
	ports_out(%Out1: !fifo.input_port<i32>,%Out2: !fifo.input_port<i32>)
{
	...
	cal.action "$untagged0" priority=0 {
		...
		memref.store %tmp_1, %l_t1__19_d1_0[%tmp_0] : memref<4xi32>
		...
		%tmp_9 = memref.load %l_t1__19_d1_0[%tmp_8] : memref<4xi32>
		fifo.push(%Out1: !fifo.input_port<i32>, %tmp_9: i32)
		%tmp_10 = arith.constant 1 : index
		%tmp_11 = memref.load %l_t1__19_d1_0[%tmp_10] : memref<4xi32>
		fifo.push(%Out1: !fifo.input_port<i32>, %tmp_11: i32)
		...
		%tmp_18 = arith.addi %l_t2__22_d1_0, %tmp_17 : i32
		fifo.push(%Out2: !fifo.input_port<i32>, %tmp_18: i32)
		// Output Expression: End
	}
}
