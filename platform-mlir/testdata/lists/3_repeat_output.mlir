	...
	ports_out(%Out: !fifo.input_port<i32>)
{
	...
	cal.action "$untagged0" priority=0 {
		...
		%tmp_7 = arith.addi %tmp_6, %l_t__6_d1_0 : i32
		memref.store %tmp_7, %l_list__8_d1_0[%tmp_4] : memref<4xi32>
		// Assignment Statement: End
		// Assignment Statement: Start
		%tmp_8 = arith.constant 1 : i1
		%tmp_9 = arith.extui %tmp_8 : i1 to i32
		%tmp_10 = arith.index_cast %tmp_9: i32 to index
		%tmp_11 = arith.constant 30 : i5
		%tmp_12 = arith.extui %tmp_11 : i5 to i32
		%tmp_13 = arith.addi %tmp_12, %l_t__6_d1_0 : i32
		memref.store %tmp_13, %l_list__8_d1_0[%tmp_10] : memref<4xi32>
		// Assignment Statement: End
		// Assignment Statement: Start
		...
		%tmp_19 = arith.addi %tmp_18, %l_t__6_d1_0 : i32
		memref.store %tmp_19, %l_list__8_d1_0[%tmp_16] : memref<4xi32>
		// Assignment Statement: End
		// Assignment Statement: Start
		%tmp_20 = arith.constant 3 : i2
		%tmp_21 = arith.extui %tmp_20 : i2 to i32
		%tmp_22 = arith.index_cast %tmp_21: i32 to index
		%tmp_23 = arith.constant 10 : i4
		%tmp_24 = arith.extui %tmp_23 : i4 to i32
		%tmp_25 = arith.addi %tmp_24, %l_t__6_d1_0 : i32
		memref.store %tmp_25, %l_list__8_d1_0[%tmp_22] : memref<4xi32>
		// Assignment Statement: End
		// Assignment Statement: Start
		...
		%tmp_32 = arith.constant 2 : index
		%tmp_33 = memref.load %l_list__8_d1_0[%tmp_32] : memref<4xi32>
		fifo.push(%Out: !fifo.input_port<i32>, %tmp_33: i32)
		%tmp_34 = arith.constant 3 : index
		%tmp_35 = memref.load %l_list__8_d1_0[%tmp_34] : memref<4xi32>
