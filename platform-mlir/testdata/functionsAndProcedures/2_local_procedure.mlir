	...
	ports_out(%Out: !fifo.input_port<i32>)
{
	...
	cal.action "transmit" priority=0 {
		// Guard: Start
		cal.predicate {
			%tmp_2 = cal.get(%l_counter__17: !cal.state_ref<i32>) : i32
...
func.func @DUT1_l_processRxItem__7(%l_temp__5: !cal.state_ref<i32>, %l_temp1__6: !cal.state_ref<i32>, %l_dataItem_d0_0: i32) {
	...
	ports_out(%Out: !fifo.input_port<i32>)
{
	...
	cal.action "$untagged0" priority=0 {
		...
		// Input Pattern: End
		// Call Statement: Start
		%tmp_4 = cal.get(%l_temp__5: !cal.state_ref<i32>) : i32
		fifo.print("TempIn: %i %i\n\00", %tmp_4, %l_t__9_d1_0) : (i32, i32)
		// Call Statement: End
		// Call Statement: Start
		%tmp_5 = cal.get(%l_temp1__6: !cal.state_ref<i32>) : i32
		func.call @DUT1_l_processRxItem__7(%l_temp__5, %l_temp1__6, %tmp_5) : (!cal.state_ref<i32>, !cal.state_ref<i32>, i32) -> ()
		// Call Statement: End
		// Call Statement: Start
...
func.func @DUT2_l_processRxItem__13(%l_temp__11: !cal.state_ref<i32>, %l_temp1__12: !cal.state_ref<i32>, %l_dataItem_d0_0: i32) {
	// Block Statement: Begin
	//     Variable declarations attached to block statement: Begin
	%tmp_0 = arith.constant 1 : i1
	%tmp_1 = arith.extui %tmp_0 : i1 to i32
	...
	ports_out(%Out: !fifo.input_port<i32>)
{
	...
	cal.action "$untagged0" priority=0 {
		...
		// Input Pattern: End
		// Call Statement: Start
		%tmp_4 = cal.get(%l_temp__11: !cal.state_ref<i32>) : i32
		fifo.print("TempIn: %i %i\n\00", %tmp_4, %l_t__15_d1_0) : (i32, i32)
		// Call Statement: End
		// Call Statement: Start
		%tmp_5 = cal.get(%l_temp1__12: !cal.state_ref<i32>) : i32
		func.call @DUT2_l_processRxItem__13(%l_temp__11, %l_temp1__12, %tmp_5) : (!cal.state_ref<i32>, !cal.state_ref<i32>, i32) -> ()
		// Call Statement: End
		// Call Statement: Start
