	...
	ports_out(%Out: !fifo.input_port<i32>)
{
	...
	cal.action "$untagged0" priority=0 {
		...
		%l_t2__13_d1_0 = fifo.pop(%In: !fifo.output_port<i32>) : i32
		// Input Pattern: End
		// Output Expression: Start
		fifo.push(%Out: !fifo.input_port<i32>, %l_t2__13_d1_0: i32)
		fifo.push(%Out: !fifo.input_port<i32>, %l_t1__10_d1_0: i32)
		// Output Expression: End
	}
}
...
cal.network
{
	...
	%queue_from_source_Out, %queue_to_DUT_In = fifo.create<i32>(2) : !fifo.input_port<i32>, !fifo.output_port<i32>
	%queue_from_DUT_Out, %queue_to_sink_In = fifo.create<i32>(2) : !fifo.input_port<i32>, !fifo.output_port<i32>
