	...
	ports_out(%Out: !fifo.input_port<i32>)
{
	...
	cal.action "transmit" priority=0 {
		...
		%tmp_10 = arith.extui %tmp_9 : i2 to i32
	...
	ports_out(%Out: !fifo.input_port<i32>)
{
	...
	cal.action "$untagged0" priority=0 {
		...
		// l_x__7_d1_1 aliased to tmp_5
		// Assignment Statement: End
		// Call Statement: Start
		fifo.print("%i\n\00", %tmp_5) : (i32)
		// Call Statement: End
		// If Statement: Begin
		%tmp_6 = arith.constant 0 : i32
		%tmp_7 = arith.subi %tmp_6, %l_t__5_d1_0 : i32
		%tmp_8 = arith.cmpi ne, %tmp_5, %tmp_7 : i32
		%tmp_9 = arith.constant 1 : i1
		%tmp_10 = arith.xori %tmp_8, %tmp_9 : i1
		%l_x__7_d1_2 = scf.if %tmp_10 -> (i32) {
			// Assignment Statement: Start
			%tmp_11 = arith.constant 1 : i1
			%tmp_12 = arith.extui %tmp_11 : i1 to i32
			%tmp_13 = arith.addi %tmp_5, %tmp_12 : i32
			// l_x__7_d2_0 aliased to tmp_13
			// Assignment Statement: End
		...
		// Call Statement: End
		// Assignment Statement: Start
		%tmp_14 = arith.constant 0xffffffff : i32
		%tmp_15 = arith.xori %l_x__7_d1_2, %tmp_14 : i32
		%tmp_16 = arith.constant 1 : i1
		%tmp_17 = arith.extui %tmp_16 : i1 to i32
		%tmp_18 = arith.addi %tmp_15, %tmp_17 : i32
		// l_x__7_d1_3 aliased to tmp_18
		// Assignment Statement: End
		// Call Statement: Start
		fifo.print("%i\n\00", %tmp_18) : (i32)
		// Call Statement: End
		...
		// Assignment Statement: End
		// Output Expression: Start
		fifo.push(%Out: !fifo.input_port<i32>, %tmp_18: i32)
		// Output Expression: End
	}
}
