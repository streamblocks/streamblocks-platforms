	...
	outputs(%Out: i32)
{
	dfg.loop inputs(%In: i32)
	{
		...
		%tmp_4 = arith.addi %tmp_1, %tmp_3 : i32
		// l_x__3_d0_1 aliased to tmp_4
		// Assignment Statement: End
		// Assignment Statement: Start
		%tmp_5 = arith.constant 2 : i2
		%tmp_6 = arith.extui %tmp_5 : i2 to i32
		%tmp_7 = arith.subi %tmp_4, %tmp_6 : i32
		// l_x__3_d0_2 aliased to tmp_7
		// Assignment Statement: End
		// Assignment Statement: Start
		%tmp_8 = arith.constant 10 : i4
		%tmp_9 = arith.extui %tmp_8 : i4 to i32
		%tmp_10 = arith.muli %tmp_7, %tmp_9 : i32
		// l_x__3_d0_3 aliased to tmp_10
		// Assignment Statement: End
		// Assignment Statement: Start
		%tmp_11 = arith.constant 2 : i2
		%tmp_12 = arith.extui %tmp_11 : i2 to i32
		%tmp_13 = arith.divsi %tmp_10, %tmp_12 : i32
		// l_x__3_d0_4 aliased to tmp_13
		// Assignment Statement: End
		// Assignment Statement: Start
		%tmp_14 = arith.constant 4 : i3
		%tmp_15 = arith.extui %tmp_14 : i3 to i32
		%tmp_16 = arith.remsi %tmp_13, %tmp_15 : i32
		// l_x__3_d0_5 aliased to tmp_16
		// Assignment Statement: End
		// Assignment Statement: Start
		%tmp_17 = arith.constant 1 : i1
		%tmp_18 = arith.extui %tmp_17 : i1 to i32
		%tmp_19 = arith.shrsi %tmp_16, %tmp_18 : i32
		// l_x__3_d0_6 aliased to tmp_19
		// Assignment Statement: End
		// Assignment Statement: Start
		%tmp_20 = arith.constant 6 : i3
		%tmp_21 = arith.extui %tmp_20 : i3 to i32
		%tmp_22 = arith.ori %tmp_19, %tmp_21 : i32
		// l_x__3_d0_7 aliased to tmp_22
		// Assignment Statement: End
		// Assignment Statement: Start
		%tmp_23 = arith.constant 5 : i3
		%tmp_24 = arith.extui %tmp_23 : i3 to i32
		%tmp_25 = arith.andi %tmp_22, %tmp_24 : i32
		// l_x__3_d0_8 aliased to tmp_25
		// Assignment Statement: End
		// Assignment Statement: Start
		%tmp_26 = arith.constant 1 : i1
		%tmp_27 = arith.extui %tmp_26 : i1 to i32
		%tmp_28 = arith.shli %tmp_25, %tmp_27 : i32
		// l_x__3_d0_9 aliased to tmp_28
		// Assignment Statement: End
		// Stmt Write: Begin
		dfg.push(%tmp_28) %Out : i32
		// Stmt Write: End
