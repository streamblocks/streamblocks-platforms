	...
	ports_out(%Out: !fifo.input_port<i32>)
{
	...
	cal.action "$untagged0" priority=0 {
		// Input Pattern: Start
		%l_t1__10_d1_0 = memref.alloca() : memref<4xi32>
		%tmp_0 = arith.constant 0 : index
		%tmp_1 = fifo.pop(%In: !fifo.output_port<i32>) : i32
		memref.store %tmp_1, %l_t1__10_d1_0[%tmp_0] : memref<4xi32>
		%tmp_2 = arith.constant 1 : index
		%tmp_3 = fifo.pop(%In: !fifo.output_port<i32>) : i32
		memref.store %tmp_3, %l_t1__10_d1_0[%tmp_2] : memref<4xi32>
		%tmp_4 = arith.constant 2 : index
		%tmp_5 = fifo.pop(%In: !fifo.output_port<i32>) : i32
		memref.store %tmp_5, %l_t1__10_d1_0[%tmp_4] : memref<4xi32>
		%tmp_6 = arith.constant 3 : index
		%tmp_7 = fifo.pop(%In: !fifo.output_port<i32>) : i32
		memref.store %tmp_7, %l_t1__10_d1_0[%tmp_6] : memref<4xi32>
		// Input Pattern: End
		// Action Local Variable Decl: Start
		%tmp_8 = arith.constant 0 : i1
		%tmp_9 = arith.extui %tmp_8 : i1 to i32
		// l_sum__12_d1_0 aliased to tmp_9
		// Action Local Variable Decl: End
		// Action Local Variable Decl: Start
		%tmp_10 = arith.constant 0 : i1
		%tmp_11 = arith.extui %tmp_10 : i1 to i32
		// l_index__13_d1_0 aliased to tmp_11
		// Action Local Variable Decl: End
		// While Statement: Begin
		%l_index__13_d1_1, %l_sum__12_d1_1 = scf.while(%l_index__13_d2_0 = %tmp_11, %l_sum__12_d2_0 = %tmp_9) : (i32, i32) -> (i32, i32) {
			// While Statement: Condition Check
			%tmp_12 = arith.constant 4 : i3
			%tmp_13 = arith.extui %tmp_12 : i3 to i32
			%tmp_14 = arith.cmpi slt, %l_index__13_d2_0, %tmp_13 : i32
			scf.condition(%tmp_14) %l_index__13_d2_0, %l_sum__12_d2_0 : i32, i32
		} do {
			// While Statement: Body Execution
		^tmp_15(%l_index__13_d2_0: i32, %l_sum__12_d2_0: i32):
			// Assignment Statement: Start
			%tmp_16 = arith.index_cast %l_index__13_d2_0: i32 to index
			%tmp_17 = memref.load %l_t1__10_d1_0[%tmp_16] : memref<4xi32>
			%tmp_18 = arith.addi %l_sum__12_d2_0, %tmp_17 : i32
			// l_sum__12_d2_1 aliased to tmp_18
			// Assignment Statement: End
			// Assignment Statement: Start
			%tmp_19 = arith.constant 1 : i1
			%tmp_20 = arith.extui %tmp_19 : i1 to i32
			%tmp_21 = arith.addi %l_index__13_d2_0, %tmp_20 : i32
			// l_index__13_d2_1 aliased to tmp_21
			// Assignment Statement: End
			scf.yield %tmp_21, %tmp_18: i32, i32
		}
		// While Statement: End
		// Output Expression: Start
		fifo.push(%Out: !fifo.input_port<i32>, %l_sum__12_d1_1: i32)
		// Output Expression: End
	}
}
...
cal.network
{
	...
	%queue_from_source_Out, %queue_to_DUT_In = fifo.create<i32>(4) : !fifo.input_port<i32>, !fifo.output_port<i32>
