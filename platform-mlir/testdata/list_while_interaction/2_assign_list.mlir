...
func.func @top(%In: i32) -> (i32)
{
	...
	%queue_from_AssignList_Out, %queue_to_Out = dfg.channel(4096) : i32
	%queue_from_In, %queue_to_AssignList_In = dfg.channel(4096) : i32

	// -- Connect input channels to arguments
	dfg.push(%In) %queue_from_In : i32

	// -- Instantiate actors (also known as nodes/instances)
	dfg.instantiate @AssignList // Instance name: AssignList
		inputs(%queue_to_AssignList_In)
		outputs(%queue_from_AssignList_Out) :
		(i32) -> (i32)
