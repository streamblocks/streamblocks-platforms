	...
	ports_out(%Out: !fifo.input_port<i32>)
{
	...
	cal.action "$untagged0" priority=0 {
		...
		// l_j__12_d1_0 aliased to tmp_7
		// Action Local Variable Decl: End
		// While Statement: Begin
		%l_a__11_d1_1, %l_j__12_d1_1 = scf.while(%l_a__11_d2_0 = %tmp_5, %l_j__12_d2_0 = %tmp_7) : (i32, i32) -> (i32, i32) {
			// While Statement: Condition Check
			%tmp_8 = arith.constant 5 : i3
			%tmp_9 = arith.extui %tmp_8 : i3 to i32
			%tmp_10 = arith.cmpi slt, %l_j__12_d2_0, %tmp_9 : i32
			scf.condition(%tmp_10) %l_a__11_d2_0, %l_j__12_d2_0 : i32, i32
		} do {
			// While Statement: Body Execution
		^tmp_11(%l_a__11_d2_0: i32, %l_j__12_d2_0: i32):
			// Assignment Statement: Start
			...
			%tmp_21 = arith.addi %l_j__12_d2_0, %tmp_20 : i32
			// l_j__12_d2_1 aliased to tmp_21
			// Assignment Statement: End
			// Call Statement: Start
			fifo.print("a: %i\n\00", %tmp_14) : (i32)
			// Call Statement: End
			// Call Statement: Start
			%tmp_22 = cal.get(%l_b__7: !cal.state_ref<i32>) : i32
			fifo.print("b: %i\n\00", %tmp_22) : (i32)
			// Call Statement: End
			scf.yield %tmp_14, %tmp_21: i32, i32
		}
		// While Statement: End
		// Assignment Statement: Start
		%tmp_23 = arith.constant 0 : i1
		%tmp_24 = arith.extui %tmp_23 : i1 to i32
		cal.set(%l_$state: !cal.state_ref<i32>, %tmp_24: i32)
		// Assignment Statement: End
		// Output Expression: Start
