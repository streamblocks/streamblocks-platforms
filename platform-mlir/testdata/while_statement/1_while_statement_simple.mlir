	...
	ports_out(%Out: !fifo.input_port<i32>)
{
	...
	cal.action "$untagged0" priority=0 {
		...
		%l_x__7_d1_1 = scf.while(%l_x__7_d2_0 = %tmp_3) : (i32) -> (i32) {
			// While Statement: Condition Check
			%tmp_4 = arith.constant 5 : i3
			%tmp_5 = arith.extui %tmp_4 : i3 to i32
			%tmp_6 = arith.cmpi slt, %l_x__7_d2_0, %tmp_5 : i32
			scf.condition(%tmp_6) %l_x__7_d2_0 : i32
		} do {
			// While Statement: Body Execution
		^tmp_7(%l_x__7_d2_0: i32):
			// Assignment Statement: Start
			%tmp_8 = arith.constant 1 : i1
			%tmp_9 = arith.extui %tmp_8 : i1 to i32
			%tmp_10 = arith.addi %l_x__7_d2_0, %tmp_9 : i32
			// l_x__7_d2_1 aliased to tmp_10
			// Assignment Statement: End
		...
		cal.set(%l_$state: !cal.state_ref<i32>, %tmp_12: i32)
		// Assignment Statement: End
		// Output Expression: Start
		%tmp_13 = arith.addi %l_t__5_d1_0, %l_x__7_d1_1 : i32
