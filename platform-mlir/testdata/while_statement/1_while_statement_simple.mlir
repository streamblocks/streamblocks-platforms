	...
	ports_out(%Out: !fifo.input_port<i32>)
{
	...
	cal.action "$untagged0" priority=0 {
		...
		%l_x__7_d1_1 = scf.while(%l_x__7_d2_0 = %tmp_1) : (i32) -> (i32) {
			// While Statement: Condition Check
			%tmp_2 = arith.constant 5 : i3
			%tmp_3 = arith.extui %tmp_2 : i3 to i32
			%tmp_4 = arith.cmpi slt, %l_x__7_d2_0, %tmp_3 : i32
			scf.condition(%tmp_4) %l_x__7_d2_0 : i32
		} do {
			// While Statement: Body Execution
		^tmp_5(%l_x__7_d2_0: i32):
			// Assignment Statement: Start
			%tmp_6 = arith.constant 1 : i1
			%tmp_7 = arith.extui %tmp_6 : i1 to i32
			%tmp_8 = arith.addi %l_x__7_d2_0, %tmp_7 : i32
			// l_x__7_d2_1 aliased to tmp_8
			// Assignment Statement: End
			scf.yield %tmp_8: i32
		}
		// While Statement: End
		// Output Expression: Start
		%tmp_9 = arith.addi %l_t__5_d1_0, %l_x__7_d1_1 : i32
		fifo.push(%Out: !fifo.input_port<i32>, %tmp_9: i32)
		// Output Expression: End
	}
}
...
cal.network
{
	...
	cal.create_instance @WhileSimple "pass" ()
